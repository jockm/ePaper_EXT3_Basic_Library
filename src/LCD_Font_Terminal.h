///
/// @file       LCD_Font_Terminal.h
/// @brief      Library header
/// @details    LCD_Font_Terminal
/// @n
...
#ifndef LCD_FONT_TERMINAL_RELEASE
///
/// @brief	Release
///
...
enum fontNumber_e
{
    Font_Terminal6x8, ///< Terminal 6x8
    Font_Terminal8x12, ///< Terminal 8x12
    Font_Terminal12x16, ///< Terminal 12x16
    Font_Terminal16x24, ///< Terminal 16x24
};
/// @}
...
struct font_s
{
    ...
    uint8_t maxWidth;   ///< maximum width in pixels
    uint8_t first;      ///< number of first character, 32
    uint8_t number;     ///< number of characters, 96 or 224
};
...
class LCD_font_Terminal
{
  ...
  protected:
    ...
    ///
    font_s _font;           ///< font
    uint8_t _fontNumber;    ///< number of fonts available, 0.._fontNumber-1
    uint8_t _fontSize;      ///< actual font selected
    uint8_t _fontSpaceX;    ///< pixels between two characters, horizontal axis
    uint8_t _fontSpaceY;    ///< pixels between two characters, vertical axis
    bool _fontSolid;        ///<
    /// @}
};
/// @endcond
...
#endif // LCD_FONT_TERMINAL_RELEASE
