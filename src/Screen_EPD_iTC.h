...
///
/// @{
#define CONFIGURATION_BOOSTERPACK 1 ///< default BoosterPack
#define CONFIGURATION_MSP5430FR5994 2 ///< specific MSP5430FR5994
#define CONFIGURATION_RASPI 3 ///< specific Raspberry Pi
#define CONFIGURATION_REDBEAR_DUO 4 // specific REDBEAR_DUO

#define CONFIGURATION_OPTION CONFIGURATION_BOOSTERPACK ///< selected option
/// @}
...
/// @note   Supported and tested screens
